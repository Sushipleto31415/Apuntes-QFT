...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE,RO]{\textcolor[RGB]{127,127,127}{Ejercicios introducción a QFT}}
\fancyfoot[LE,RO]{\thepage}
\fancyfoot[LO,RE]{A. Diaz y F.Mella}
...
\subfile{subfiles/ejercicios1} %oyee ns si te tinca renombrar las secciones como del tema q se trata tipo...clase 1-> Invarianza de la acción/ecuaciones de Euler-Lagrange

\subfile{subfiles/ejercicios2}

\subfile{subfiles/ejercicios3}

\subfile{subfiles/ejercicios4}

\subfile{subfiles/ejercicios5}

\subfile{subfiles/ejercicios6}
