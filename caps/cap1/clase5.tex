...
\begin{align*}
  \hat{E}\Psi  & = \hbar \omega \Psi  \rightarrow   p  = -\hbar \frac{\partial}{\partial x}\\
...
\begin{align*}
E^2  & = p^2c^2 + m^2c^4 \\
  -\hbar \partia^2_t \Psi & = -c\hbar^2\partial^2_x \Psi + m^2c^4 \Psi \quad, \quad /\frac{1}{\hbar^2c^2}\\  
  \frac{1}{c^2}\paetial_t^2\Psi - \partial^2_x \Psi  + \frac{m^2c^2}{h^2}\Psi &= 0
\end{align*}
Con lo cual, hemos llegado a la siguiente ecuación
\begin{equation}
  \boxed{\frac{1}{c^2}\partial^2_t\Psi - \partia^2_x\Psi + \frac{m^2c^2}{\hbar^2}\Psi = 0}
\end{equation}
...
\begin{align*}
  ...
  \Psi^*\parial^2_t \Psi^* - \Psi \partial^2_t \Psi^* \Psi \partial^2_x \Psi^*- \Psi^*\partial^2_x \Psi & = 0 \\
