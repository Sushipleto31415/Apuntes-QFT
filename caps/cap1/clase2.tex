...
En la última clase repasamos algo de física de mećanica clásica y vimos una introducción algo general de la necesidad de enontrar un marco conceptuál algo más general de la mecán\ica clásica ya que necesitamos describir un proceso que ocurre en la naturaleza en el cual el estado inicial no es el mismo del final.
